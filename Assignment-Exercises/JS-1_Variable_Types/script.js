...
// Using let
let name = "Yuki Flores"; // Define a string here, e.g., "Juan Cruz"
let age =  5; // Define a number here, e.g., 30
let isStudent = true ; // Define a boolean here, e.g., true or false
let hobbies = ["eating", "sleeping", "running"]; // Define an array here, e.g., ["reading", "gaming", "coding"]
...
const birthYear = 2020; // Define a number here, e.g., 1990
...
var temperature = 11.1; // Define a number here, e.g., 22.5
var hasPets = false; // Define a boolean here, e.g., true or false
var colors = ["beige", "yellow", "gold"]; // Define an array here, e.g., ["red", "green", "blue"]
